...
import { FaMoon, FaSun, FaCalendarAlt, FaMoneyBillWave, FaChartBar, FaFileContract } from 'react-icons/fa';
  ...
  const features = [
    {
      ...
      description: 'Streamline leave requests, track absences, and manage employee time-off efficiently with our automated system.',
    },
    {
      icon: FaMoneyBillWave,
      title: 'Payroll Tracking',
      description: 'Simplify payroll processing with automated calculations, tax deductions, and detailed salary reports.',
    },
    {
      icon: FaChartBar,
      title: 'Accounting Reports',
      description: 'Generate comprehensive financial reports, analyze expenses, and make data-driven decisions with ease.',
    },
    {
      icon: FaFileContract,
      title: 'Contract & Document Management',
      description: 'Securely store, manage, and track all employee contracts and important documents in one centralized location.',
    },
  ];
    ...
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      ...
      <header className="relative overflow-hidden">
        <nav className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          >
            <img src="/logo.png" alt="BlueBird HR" className="h-8 w-auto" />
            <h1 className="ml-2 text-2xl font-bold">BlueBird HR</h1>
          </motion.div>
